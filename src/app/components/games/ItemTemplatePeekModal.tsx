...
export function ItemTemplatePeekModal({ item, onClose }: Props) {
  ...
  return (
    ...
    >
      <div
        className="max-h-[min(70vh,28rem)] w-full max-w-sm overflow-y-auto rounded-t-2xl border-2 border-white border-b-0 bg-modalBackground-200 px-4 pb-6 pt-3 shadow-xl sm:rounded-2xl sm:border-b-2"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="mx-auto mb-2 h-1 w-10 shrink-0 rounded-full bg-white/30 sm:hidden" />
        ...
        <div className="mt-3 space-y-2.5 text-xs text-white/90">
