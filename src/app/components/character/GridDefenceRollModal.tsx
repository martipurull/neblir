...
export interface GridDefenceRollModalProps {
  isOpen: boolean;
  onClose: () => void;
  /** Number of d10 attack dice to roll (GRID defence mod). */
  defenceDice: number;
  /** Optional small helper text describing how modifier is computed. */
  modifierHint?: string;
  /** When true, consuming a reaction is not possible (grey out roll). */
...
export function GridDefenceRollModal({
  isOpen,
  onClose,
  defenceDice,
  modifierHint,
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="grid-defence-roll-modal-title"
      onClick={onClose}
    >
      <div
      ...
      >
        <div className="flex items-center justify-between">
          <h2
            id="grid-defence-roll-modal-title"
