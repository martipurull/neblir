        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="button"
              onClick={handleRoll}
              className="flex-1 rounded-md border-2 border-white bg-white py-2.5 text-sm font-semibold text-black transition-colors hover:bg-white/90"
            >
              ROLL
            </button>
            <button
