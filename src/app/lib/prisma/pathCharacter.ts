...
export async function createPathCharacter(data: Prisma.PathCharacterUncheckedCreateInput) {
...
export async function updatePathCharacter(id: string, data: Prisma.PathCharacterUpdateInput) {
